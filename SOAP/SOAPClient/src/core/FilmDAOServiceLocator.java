...
public class FilmDAOServiceLocator extends org.apache.axis.client.Service implements core.FilmDAOService {
    ...
    private java.lang.String FilmDAO_address = "http://localhost:8080/SOAP/services/FilmDAO";
    ...
    public core.FilmDAO getFilmDAO(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            core.FilmDAOSoapBindingStub _stub = new core.FilmDAOSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (core.FilmDAO.class.isAssignableFrom(serviceEndpointInterface)) {
                core.FilmDAOSoapBindingStub _stub = new core.FilmDAOSoapBindingStub(new java.net.URL(FilmDAO_address), this);
                _stub.setPortName(getFilmDAOWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://core", "FilmDAOService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://core", "FilmDAO"));
        }
